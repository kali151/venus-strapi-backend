...
export interface ApiContactPageContactPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    announcement: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    > &
      Schema.Attribute.Private;
    mapEmbed: Schema.Attribute.Blocks;
...
export interface ApiSpaServiceSpaService extends Struct.CollectionTypeSchema {
  collectionName: 'spa_services';
  info: {
    displayName: 'SpaService';
    pluralName: 'spa-services';
    singularName: 'spa-service';
  };
  options: {
    draftAndPublish: true;
  };
